...
// The red heptagon that appears has sides that are 2155 pixels long
...
ellipse(350, 500, 120, 120);
ellipse(350, 725, 180, 180) ;
rect(230, 575, 50, 20) ;
rect(420, 575, 50, 20);
